                    ...
                    <div class="card card-outline card-info">
                        <div class="card-header" style="background-color: #ec8a95">
                            <h3 class="card-title">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <select class="form-select form-control-sm" id="idStep" data-placeholder="Choose Items" style="width: 150px;">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <select class="form-select form-control-sm" id="idClass" data-placeholder="Choose Items" style="width: 150px;">
                                        <option value="v0"></option>
                                    </select>&nbsp;&nbsp;
                        ...
                        <div class="card-body pad" style="background-color: #f8d7da">
                            <div class="d-flex align-items-end justify-content-end" style="margin-bottom: 10px;">
                                ...
                                <button class="btn btn-success" type="button" data-toggle="tooltip" title="원아 프린트 하기" onclick="orderToPdf()"><i class="fa-solid fa-print"></i>출력
                                </button>
                            </div>
