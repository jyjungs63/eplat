                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control form-control-sm" id="idOwner" type="text" placeholder="지사/유치원명" style="width: 100px;">&nbsp;

                                    <input class="form-control form-control-sm" id="idName" type="text" placeholder="이름" style="width: 150px;">&nbsp;

                                    <input class="form-control form-control-sm" id="idMobile" type="text" placeholder="전화번호" style="width: 100px;">&nbsp;
                            ...
                            <div class="card-tools" id="idCardBranchManage">
