...
<body>
                    ...
                    <div class="card card-outline card-info card-tabs" id="idCardPurchase">
                        <div class="card-header">
                            ...
                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Purchase List</a>
                                </li>
                            </ul>
                            <div class="card-tools">
                                <button id="idCardPurchaseBtn" type="button" class="btn  btn-md btn-primary" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">접기
                                </button>
                            ...
                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                    ...
                                    <div class="d-flex align-items-end justify-content-end" style="margin-bottom: 10px;">
                                        ...
                                        <a id="anchorRead" href="javascript:orderToPdf()" class="btn btn-success" role="button" data-toggle="tooltip" title="Save PDF file" aria-disabled="true"><i class="fa-solid fa-file-pdf"></i></a>
                                        &nbsp;&nbsp;
                                        <a id="anchorRead" href="javascript:orderPrint()" class="btn btn-warning" role="button" data-toggle="tooltip" title="Order and PDF file" aria-disabled="true"><i class="fa-solid fa-print"></i></a>
                                        &nbsp;&nbsp;

                                        <a id="anchorRead" href="javascript:orderBook()" class="btn btn-info" role="button" data-toggle="tooltip" title="Add to Cart " aria-disabled="true"><i class="fa-solid fa-cart-shopping"></i></a>&nbsp;&nbsp;
                                ...
                                <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                    ...
                                    &nbsp;&nbsp; -->
                                        <select class="form-select form-control-sm" id="idPorList" data-placeholder="Choose Items" style="width: 120px">
                                        </select>
                                        <input class="form-control form-control-sm" id="reportrange" style="width: 85px">
                                        <i class="fa fa-calendar" style="margin-top: 7px; margin-left: 2px"></i>&nbsp;
                                        </input>
                                        &nbsp;
                                        <input class="form-control form-control-sm" id="idID2" type="text" placeholder="아이디">
                                        &nbsp;
                                        <input class="form-control form-control-sm" id="idName2" type="text" placeholder="이름">
                                        &nbsp;
                                        <input class="form-control form-control-sm" id="idOwner2" type="text" placeholder="Owner">&nbsp;
                                        <input class="form-control form-control-sm" id="idPasswd2" type="text" placeholder="비밀번호">
                                        &nbsp;
                                        <input class="form-control form-control-sm" id="idMobile2" type="text" placeholder="전화번호" style="width: 70px;">
                                        &nbsp;
                                        <input class="form-control form-control-sm" id="idAddr2" type="text" placeholder="주소" style="width: 120px;">
                                        &nbsp;
                                        <input class="form-control form-control-sm" id="idFinish2" type="text" placeholder="구매완료" style="width: 50px;">
                                        &nbsp;
                                        <input class="form-control form-control-sm" id="idRdate2" type="text" placeholder="구매일" style="width: 5px;">
                                        &nbsp;
                                        <button class="btn btn-outline-primary btn-sm" type="button" onclick="execDaumPostcode('idZip','idAddr2' )">
                                            주소찾기</button>
                                        &nbsp;
    ...
    <div class="p-3">
        ...
        <section class="content">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control form-control-sm" id="idPasswd" type="text" placeholder="비밀번호">
                                &nbsp;
                                ...
                                &nbsp;
                                <input class="form-control form-control-sm" id="idZip" type="text" placeholder="우편번호" style="width: 20px;">
                                &nbsp;
                                <button class="btn btn-outline-primary btn-sm" type="button" onclick="execDaumPostcode( 'idAddr','idZip')">
                                    주소찾기</button>
                                &nbsp;
                                <button class="btn btn-outline-success btn-sm" type="button" onclick="AddBranch()">배송지추가
                                </button>
                            ...
                            <div class="card-tools" id="idCardAddress">
                                <button id="idCardAddressBtn" type="button" class="btn  btn-md btn-success" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                                    펴기</button>
                                <!-- <button type="button" class="btn btn-tool btn-sm" data-card-widget="remove"
                                    data-toggle="tooltip" title="Remove">
                                    <i class="fas fa-times"></i></button> -->
            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary" id="idCardPDF">
                    <div class="card-header">
                        <h3 class="card-title">
                            <p> <b>구매내역서</b></p>
                        </h3>
                        <div class="card-tools">
                            <button id="idCardPDFBtn" type="button" class="btn btn-md btn-warning" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                                펴기</button>
                            <!-- <button type="button" class="btn btn-tool btn-sm" data-card-widget="remove"
                                data-toggle="tooltip" title="Remove">
                                <i class="fas fa-times"></i></button> -->
