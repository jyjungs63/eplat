                    ...
                    <div class="card card-outline card-info" id="cardList">
                        ...
                        <button id="button" class="btn btn-secondary">삭제</button>
                            ...
                            <div class="mb-3 table-responsive">
                                <table id="table" data-pagination="true" data-page-size="5" data-search="true" data-striped="true" data-row-style="rowStyle">
                                    <thead>
                                        <tr>
                                            <th data-field="num" data-width="50" class="mobile-hide" class="mobile-hide">순서</th>
                                            <th data-field="title" data-width="300">제목</th>
                                            <th data-field="id" data-width="150" class="mobile-hide">작성자</th>
                                            <th data-field="rdate" data-width="150" class="mobile-hide" class="mobile-hide">날짜</th>
                                            <th data-field="file" data-width="150">File</th>
                                            <!-- <th data-field="file" data-width="150">삭제</th> -->
                            ...
                            <div class="mb-3 table-responsive">
                                <form id="form" method="post" enctype="multipart/form-data">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <button type="button" id="btToggle" onclick="closeDownload()" class="btn btn-primary" data-dismiss="modal">자료실가기</button>
                                        </div>
