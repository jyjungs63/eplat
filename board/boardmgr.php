                        ...
                        <div class="card-body pad" style="background-color:#88babe87">
                            ...
                            <div class="mb-3 table-responsive">
                                <div class="d-flex" id="toolbar" style="width: 400px ; height: 40px">
                                    <button id="button" class="btn btn-danger btn-sm" style="width:150px"><i class="fa fa-trash"></i> &nbsp;삭제</button>
                                    &nbsp;&nbsp;
                                ...
                                <table id="idBoardtable" data-pagination="true" data-page-size="10" data-search="true" data-id-field="id" data-row-style="rowStyle" data-toolbar="#toolbar">
                                    <thead>
                                        <tr>
                                            <th data-field="num" data-width="50" class="mobile-hide" data-sortable="true" class="mobile-hide">순서</th>
                                            <th data-field="title" data-width="300" data-sortable="true">제목</th>
                                            <th data-field="cate" data-width="150" class="mobile-hide" data-sortable="true">분류</th>
                                            <!-- <th data-field="id" data-width="150" class="mobile-hide">종류</th> -->
                                            <th data-field="rdate" data-width="150" class="mobile-hide" class="mobile-hide" data-sortable="true">날짜</th>
                            ...
                            <div class="mb-3 table-responsive">
                                <form id="form" method="post" enctype="multipart/form-data">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-25">
                                                <label id="dvPreviewLB" for="dvPreview" class="control-label" style="display: none">Files</label>
                                            </div>
                                            <div class="col-75">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="box">
                                                ...
                                                <div class="col-75 inset-border" id="idFiles" style="border: 1px solid gray;padding: 10px;margin-bottom: 10px;">
                                        ...
                                        <div class="row">
                                            <button type="button" id="btToggle" onclick="closeDownload()" class="btn btn-primary bt-sm" data-dismiss="modal">자료실가기</button>
                                        </div>
