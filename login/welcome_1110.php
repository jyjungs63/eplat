...
<body style="overflow: auto;height:100%">
    ...
    <div class="row">
        <div class="col-lg-6 ">
            <div class="row  shadow" style="height:260px;background-color: #DACBF4;border-radius: 25px;margin:0px 10px 10px ;padding: 10px 10px ">
                <img style="width:100%; height: 100%" src='..\assets\img\online_study_room\internal_images\intro.png' class="rounded img-responsive"></img>
            </div>
        </div>
                        ...
                        <tbody>
                            <tr>
                                <td class="talign thh" style="background-color: #38B6FF;height: 80px;">
                                    <div class="d-grid">
                                        <button class="btn btn-block" id="s1" value="#38B6FF" onclick="changecolor(this)" style="background-color: #38B6FF;"><b>BASIC</b>
                                        </button>
                                    </div>
                                </td>
                                <td class="talign thh" style="height: 50px;">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <select id="select-field" class="form-select">
                                            <option></option>
                                            <option val="v1" disabled="disabled">v1</option>
                            ...
                            <tr>
                                <td class="talign thh" style="background-color: #E60012;height: 80px;">
                                    <div class="d-grid">
                                        <button class="btn btn-block" id="s1" value="#E60012" onclick="changecolor(this)" style="background-color: #E60012;"><b>STEP 1</b>
                                        </button>
                                    </div>
                                </td>
                                <td class="talign thh">
                            ...
                            <tr>
                                <td class="talign thh" style="background-color: #F6B33E;height: 80px;">
                                    <div class="d-grid">
                                        <button class="btn btn-block" id="s1" value="#F6B33E" onclick="changecolor(this)" style="background-color: #F6B33E;"><b>STEP 2</b>
                                        </button>
                                    </div>
                                </td>
                                <td class="talign thh">
                                    <div class="form-check justify-content-center align-items-center">
                                        <input id="flexCheckWeekChecked" class="form-check-input" type="checkbox" value="" onclick="javascript:assignHref(1)">
                            ...
                            <tr>
                                <td class="talign thh" style="background-color: #01A01D ;height: 80px;"> 
                                    <div class="d-grid">
                                        <button class="btn btn-block" id="s1" value="#01A01D" onclick="changecolor(this)" style="background-color: #01A01D ;"><b>STEP 3</b>
                                        </button>
                                    </div>
                                </td>
                                <td class="talign thh">
                                    <span class="d-flex justify-content-center align-items-center input-group-text">
                                        ...
                                        <a href="https://www.eplat.co.kr/login/login.php" style="text-decoration-line: none;"> <i class="fa fa-power-off fa-3x" style="color: steelbule;"></i></a>
                                    </span>
                            ...
                            <tr>
                                <td height="30" class="talign thh align-middle">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Monthly Song</p><br>
                                        <p style="font-size:xx-small;text-align:center" id="w1_1_t"></p>
                                    </div>
                                ...
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Phonics Song</p></br><p style="font-size:xx-small" id="w1_5_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy Song</p></br><p style="font-size:xx-small" id="w1_2_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        6. <a id="w1_6" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon6.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics read</p></br><p style="font-size:xx-small" id="w1_6_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy read</p></br><p style="font-size:xx-small" id="w1_3_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        7. <a id="w1_7" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon7.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics sentence</p></br><p style="font-size:xx-small" id="w1_7_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy sentence</p></br><p style="font-size:xx-small" id="w1_4_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        8. <a id="w1_8" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon8.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Rhythm</p></br><p style="font-size:xx-small" id="w1_8_t"></p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
        ...
        <div class="col-lg-6 " style="margin-top:5px"> <!-- Tab content 1  -->
            <div class="row  shadow " style="background-color: #DACBF4;border-radius: 25px;margin:0px 10px;">
                <div class="" style="margin-top: 10px; text-align: center">
                            ...
                            <tr>
                                <td height="30" class="talign thh align-middle">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span style="font-size:xx-small"><b>Monthly Song</span></br><span style="font-size:xx-small" id="w2_1_t"></span>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        5. <a id="w2_5" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon5.png' class="img-thumbnail" /></span></a>
                                        <span style="font-size:xx-small"><b>Phonics Song</span></br><span style="font-size:xx-small" id="w2_5_t"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy Song</p></br><p style="font-size:xx-small" id="w2_2_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        6. <a id="w2_6" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon6.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics read</p></br><p style="font-size:xx-small" id="w2_6_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy read</p></br><p style="font-size:xx-small" id="w2_3_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        7. <a id="w2_7" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon7.png' class="img-thumbnail" /></span></a>
                                        <span style="font-size:xx-small"><b>Phonics sentence</span></br><span style="font-size:xx-small" id="w2_7_t"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy sentence</p></br><p style="font-size:xx-small" id="w2_4_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        8. <a id="w2_8" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon8.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Rhythm</p></br><p style="font-size:xx-small" id="w2_8_t"></p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <tr>
                                <td height="30" class="talign thh align-middle">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Monthly Song</p></br><p style="font-size:xx-small" id="w3_1_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        5. <a id="w3_5" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon5.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics Song</p></br><p style="font-size:xx-small" id="w3_5_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy Song</p></br><p style="font-size:xx-small" id="w3_2_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        6. <a id="w3_6" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon6.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics read</p></br><p style="font-size:xx-small" id="w3_6_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy read</p></br><p style="font-size:xx-small" id="w3_3_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        7. <a id="w3_7" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon7.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics sentence</p></br><p style="font-size:xx-small" id="w3_7_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy sentence</p></br><p style="font-size:xx-small" id="w3_4_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        8. <a id="w3_8" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon8.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Rhythm</p></br><p style="font-size:xx-small" id="w3_8_t"></p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <tr>
                                <td height="30" class="talign thh align-middle">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Monthly Song</p></br><p style="font-size:xx-small" id="w4_1_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        5. <a id="w4_5" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon5.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics Song</p></br><p style="font-size:xx-small" id="w4_5_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy Song</p></br><p style="font-size:xx-small" id="w4_2_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        6. <a id="w4_6" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon6.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics read</p></br><p style="font-size:xx-small" id="w4_6_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy read</p></br><p style="font-size:xx-small" id="w4_3_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        7. <a id="w4_7" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon7.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Phonics sentence</p></br><p style="font-size:xx-small" id="w4_7_t"></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p style="font-size:xx-small"><b>Stroy sentence</p></br><p style="font-size:xx-small" id="w4_4_t"></p>
                                    </div>
                                </td>
                                <td height="30" class="talign thh">
                                    <div class="d-flex align-items-center">
                                        8. <a id="w4_8" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon8.png' class="img-thumbnail" /></span></a>
                                        <p style="font-size:xx-small"><b>Rhythm</p></br><p style="font-size:xx-small" id="w4_8_t"></p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
    ...
    <script>
        function assignHref(week) {
            ...
            res.forEach(el => { // 4 week i
                cont.forEach(element => {
                    ...
                    var myid = "#w" + (i + 1) + "_" + k;
                    var mmyid = "#w" + (i + 1) + "_" + k++ + "_t";
                    //$(mmyid).text(res[i][element].split('-')[0]);
                    if (chk)
        ...
        $(document).ready(function() {
            ...
            $("#select-field, #iselect-field2").select2({
                theme: "bootstrap-5",
            ...
            //$(".select2-selection").css("background-color", "#38B6FF");
        ...
        $('#iselect-field2').on('select2:select', function(e) {
