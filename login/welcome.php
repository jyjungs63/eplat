                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="talign thh" style="background-color: #01A01D ;height: 80px;">
                                    <div class="d-grid">
                                        <button class="btn btn-block" id="step3" value="#01A01D" onclick="changecolor(this)" style="background-color: #01A01D ;"><b>STEP
                                                3</b>
                                        </button>
                                    </div>
                                </td>
                                <td class="talign thh colr">
                                    <span class="d-flex justify-content-center align-items-center input-group-text colr">
                                        <a href="https://www.eplat.co.kr" style="text-decoration-line: none;"> <i class="fa fa-home fa-2x" style="color: green;"> </i></a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="https://www.eplat.co.kr/login/login.php" style="text-decoration-line: none;"> <i class="fa fa-sign-out fa-2x" style="color: steelbule;"></i></a>&nbsp;&nbsp;&nbsp;
                                        <a href="#" onclick="myFunction(); return false;" style="text-decoration-line: none;"> <i class="fa-solid fa-arrows-rotate fa-2x" style="color: red;"></i></a>
            ...
            <div class="row  shadow" style="background-color: #DACBF4;border-radius: 25px;margin:0px 10px;">
                <div class="" style="margin-top: 10px; text-align: center">
                    <table class="table  rounded rounded-4 giro-table  boder-success overflow-hidden" style="table-layout:fixed;word-break:break-all;">
                        <thead>
                            <tr class="">
                                <th height="70" style="font-size: 1.5rem; background-color:#271841;color:white;text-align: -webkit-center;" class="talign " scope="col" colspan="1">1st Week</th>
                                <th height="70" style="font-size: 1.2rem; background-color:#412c6f;color:white;text-align: -webkit-center;" class="talign " scope="col" colspan="1">
                                    <span><a id="w1_g" href="#"><span><img src='..\memory-game\game.jpg' class="img-thumbnail img-thumbnail1" /></span></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span><a id="w1_e" href="#"><span><img src='..\memory-game\extr.jpg' class="img-thumbnail img-thumbnail1" /></span></a></span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="row  shadow " style="background-color: #DACBF4;border-radius: 25px;margin:0px 10px;">
                <div class="" style="margin-top: 10px; text-align: center">
                    <table class="table table-hover rounded rounded-4 giro-table  boder-success overflow-hidden" style="table-layout:fixed;word-break:break-all;height:auto">
                        <thead>
                            <tr class="">
                                <th height="70" style="font-size: 1.5rem; background-color:#271841;color:white;text-align: -webkit-center;" class="talign" scope="col" colspan="1">2nd Week</th>
                                <th height="70" style="font-size: 1.2rem; background-color:#412c6f;color:white;text-align: -webkit-center;" class="talign " scope="col" colspan="1">
                                    <span><a id="w2_g" href="#"><span><img src='..\memory-game\game.jpg' class="img-thumbnail img-thumbnail1" /></span></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span><a id="w2_e" href="#"><span><img src='..\memory-game\extr.jpg' class="img-thumbnail img-thumbnail1" /></span></a></span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="row shadow   mt-2" style="background-color: #DACBF4;border-radius: 25px;margin:0px 10px;">
                <div class="" style="margin-top: 10px; text-align: center">
                    <table class="table table-hover  rounded rounded-4 giro-table  boder-success overflow-hidden" style="table-layout:fixed;word-break:break-all;height:auto">
                        <thead>
                            <tr class="">
                                <th height="70" style="font-size: 1.5rem; background-color:#271841;color:white;text-align: -webkit-center;" class="talign" scope="col" colspan="1">3rd Week</th>
                                <th height="70" style="font-size: 1.2rem; background-color:#412c6f;color:white;text-align: -webkit-center;" class="talign " scope="col" colspan="1">
                                    <span><a id="w3_g" href="#"><span><img src='..\memory-game\game.jpg' class="img-thumbnail img-thumbnail1" /></span></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span><a id="w3_e" href="#"><span><img src='..\memory-game\extr.jpg' class="img-thumbnail img-thumbnail1" /></span></a></span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="row shadow   mt-2 " style="background-color: #DACBF4;border-radius: 25px;margin:0px 10px;">
                <div class="" style="margin-top: 10px; text-align: center">
                    <table class="table table-hover  rounded rounded-4 giro-table  boder-success overflow-hidden" style="table-layout:fixed;word-break:break-all;height:auto">
                        <thead>
                            <tr class="">
                                <th height="70" style="font-size: 1.5rem; background-color:#271841;color:white;text-align: -webkit-center;" class="talign" scope="col" colspan="1">4th Week</th>
                                <th height="70" style="font-size: 1.2rem; background-color:#412c6f;color:white;text-align: -webkit-center;" class="talign " scope="col" colspan="1">
                                    <span><a id="w4_g" href="#"><span><img src='..\memory-game\game.jpg' class="img-thumbnail img-thumbnail1" /></span></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span><a id="w4_e" href="#"><span><img src='..\memory-game\extr.jpg' class="img-thumbnail img-thumbnail1" /></span></a></span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="modal-dialog modal-smaller fixed-bottom" role="document" style="width: 700px;">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="py-1"><button id="idClose" type="button" class="btn btn-sm btn-outline-success rounded-pill px-5" data-bs-dismiss="modal">OK</button>
                    </div>
                </div>
            </div>
        </div>
