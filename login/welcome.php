                                ...
                                <td class="talign thh colr" style="height: 50px;">
                                    ...
                                    <div id="leftdiv" class="input-group ">
                                        ...
                                        <select id="select-field" class="form-select">
                                            ...
                                            <option val="v3" disabled>v3</option>
                    ...
                    <table class="table  rounded rounded-4 giro-table  boder-success overflow-hidden" style="table-layout:fixed;word-break:break-all;">
                        <thead>
                            <tr class="">
                                ...
                                <th height="70" style="font-size: 1.5rem; background-color:#271841;color:white;text-align: -webkit-center;" class="talign " scope="col" colspan="1">
                                    <span>GAME&nbsp;<a id="w1_5555" href="../memory-game/index.html"><span><img src='..\assets\img\online_study_room\internal_images\online_icon5.png' class="img-thumbnail" /></span></a></span>
                                    &nbsp;&nbsp;
                                    <!-- <span><a id="w1_5" href="#"><span><img src='..\assets\img\online_study_room\internal_images\online_icon5.png' class="img-thumbnail" /></span></a></span> -->
                                </th>
                            </tr>
                        </thead>
                        <tbody>
